/*
    ...
    OpenGL loader generated by glad 0.1.34 on Tue Aug 15 04:32:14 2023.
...
//modified by me to make the string a const char* instead of a GLubyte* to be compatible with spdlog
//typedef const GLubyte * (APIENTRYP PFNGLGETSTRINGPROC)(GLenum name);
typedef const char* (APIENTRYP PFNGLGETSTRINGPROC)(GLenum name);
