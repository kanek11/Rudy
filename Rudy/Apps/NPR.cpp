...
namespace Rudy
{
    ...
    void NPR::Start()
    {
        ...
        shadowMap = Texture2D::CreateEmpty(
            TextureSpec{ SHADOW_WIDTH, SHADOW_HEIGHT,
            TextureInternalFormat::DEPTH_COMPONENT24, false, WrapMode::ClampToBorder, FilterMode::Nearest });
       ...
       auto gRoughness = Texture2D::CreateEmpty(TextureSpec{ SCR_WIDTH, SCR_HEIGHT, TextureInternalFormat::R32F });
        ...
        //===============================  
        //======lit pass
        auto gViewDepth = Texture2D::CreateEmpty(TextureSpec{ SCR_WIDTH, SCR_HEIGHT, 
            TextureInternalFormat::DEPTH_COMPONENT24, false, WrapMode::ClampToBorder, FilterMode::Nearest });
        ...
        auto litPassShader = Shader::Create("NPR Shader", 
          "Shaders/Shaders/Genshin_VS.glsl",  "Shaders/Shaders/Genshin_FS.glsl");
