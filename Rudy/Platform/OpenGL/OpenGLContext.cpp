...
void OpenGLContext::Init()
{
    ...
    // eg: disable performance warnings, shader recompilation,  data to host, etc.
    ...
    // glDebugMessageControl(GL_DEBUG_SOURCE_API, GL_DEBUG_TYPE_PERFORMANCE, GL_DEBUG_SEVERITY_HIGH, 0, nullptr, GL_FALSE);
