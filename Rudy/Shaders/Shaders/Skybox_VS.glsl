...
uniform mat4 u_projection;   //make sure the view matrix reduce to mat3, no translation part

uniform mat4 u_view;         //make sure the view matrix reduce to mat3, no translation part
void main()
{
    WorldCoords = aPos;
