...
public:
    ...
    {
        object->transform = USceneComponent::Create(object);
    }

public:
    SharedPtr<USceneComponent> transform = nullptr;
...
public:
    ...
    SharedPtr<Object> findNodeRecursive(SharedPtr<USceneComponent> node, std::string const& name);
