    ...
    m_TextureSpec(specification), m_Width(m_TextureSpec.width), m_Height(m_TextureSpec.height)
{
    ...
    {
        glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + i, 0, m_InternalFormat, m_Width, m_Height, 0, m_DataFormat, m_DataType, NULL);
    }
                                                                  ...
                                                                  uint32_t               mipLevels)
{
    ...
    switch (type)
    {
        ...
        case ConvolutionType::Diffuse:
        {
            ...
            auto prefilterEnvMap = TextureCube::CreateEmpty(TextureSpec { 32, 32, TextureInternalFormat::RGB32F, false, WrapMode::ClampToEdge, FilterMode::Linear, FilterMode::Linear });
        ...
        case ConvolutionType::Specular:
        {
            ...
            auto prefilterEnvMap = TextureCube::CreateEmpty(
                TextureSpec { 128, 128, TextureInternalFormat::RGB32F, true, WrapMode::ClampToEdge, FilterMode::LinearMipmapLinear, FilterMode::Linear });
