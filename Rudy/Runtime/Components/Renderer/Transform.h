...
public:
    ~Transform() = default;
    Transform()  = default;
    static SharedPtr<Transform> Create(SharedPtr<Object> gameObject);
...
public:
    ...
    static void UpdateWorldTransformRecursive(const SharedPtr<Transform> node, const glm::mat4& parentTransform);

public:
    // in turn reference to the game object
    SharedPtr<Object> gameObject;
};
