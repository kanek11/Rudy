...
public:
    ...
    virtual void SetColorTexture(TexType type, SharedPtr<UTexture> texture, uint32_t slot) = 0;
    virtual void SetDepthTexture(SharedPtr<UTexture> texture)                              = 0;

    virtual std::unordered_map<TexType, SharedPtr<UTexture>> GetColorTextures() = 0;
    virtual SharedPtr<UTexture>                              GetDepthTexture()  = 0;
